    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <p><strong>Subject:</strong> <?php echo e($session->subject->name); ?> (<?php echo e($session->subject->code); ?>)</p>
                                <p><strong>Code:</strong> <?php echo e($session->code); ?></p>
                                <p><strong>Status:</strong> 
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($session->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                        <?php echo e($session->is_active ? 'Active' : 'Ended'); ?>
                ...
                <form action="<?php echo e(route('teacher.sessions.update', $session)); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    
                    <div>
                        <label for="name" class="block text-sm font-medium text-gray-700">Session Name</label>
                        <input type="text" name="name" id="name" value="<?php echo e(old('name', $session->name)); ?>" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="e.g., Week 1 - Introduction, Lab Session 1, etc.">
                    ...
                    <div>
                        ...
                        <input type="text" name="section" id="section" value="<?php echo e(old('section', $session->section)); ?>" required 
                    ...
                    <div>
                        ...
                        <select name="session_type" id="session_type" required 
                            ...
                            <option value="lecture" <?php echo e(old('session_type', $session->session_type) == 'lecture' ? 'selected' : ''); ?>>Lecture</option>
                            <option value="lab" <?php echo e(old('session_type', $session->session_type) == 'lab' ? 'selected' : ''); ?>>Lab</option>
                            <option value="online" <?php echo e(old('session_type', $session->session_type) == 'online' ? 'selected' : ''); ?>>Online</option>
                        </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="datetime-local" name="scheduled_start_time" id="scheduled_start_time" 
                                value="<?php echo e(old('scheduled_start_time', $session->scheduled_start_time ? $session->scheduled_start_time->format('Y-m-d\TH:i') : '')); ?>" 
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="scheduled_end_time" id="scheduled_end_time" 
                                value="<?php echo e(old('scheduled_end_time', $session->scheduled_end_time ? $session->scheduled_end_time->format('Y-m-d\TH:i') : '')); ?>" 
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div>
                        ...
                        <input type="number" name="grace_period_minutes" id="grace_period_minutes" 
                            value="<?php echo e(old('grace_period_minutes', $session->grace_period_minutes)); ?>" 
                    ...
                    <div>
                        ...
                        <textarea name="notes" id="notes" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="e.g., Lab session, Online lecture, etc."><?php echo e(old('notes', $session->notes)); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webSys\resources\views/teacher/sessions/edit.blade.php ENDPATH**/ ?>