...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" action="{{ route('register.teacher') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="space-y-2">
                ...
                <p class="text-xs text-gray-500">Upload a profile picture (JPEG, PNG, JPG, GIF up to 2MB)</p>
            </div>
